...
namespace PharmacyManagementSystem.API.Migrations
{
    ...
    [Migration("20230612041759_RoleDataTypeChanged")]
    partial class RoleDataTypeChanged
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PharmacyManagementSystem.API.Models.Domain.Drug", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExpiryDate = new DateTime(2024, 6, 12, 9, 47, 58, 562, DateTimeKind.Local).AddTicks(5776),
                            ImageUrl = "",
                            Price = 10.2m,
                            Quantity = 200
                        },
                        new
                        {
                            ...
                            ExpiryDate = new DateTime(2024, 8, 12, 9, 47, 58, 562, DateTimeKind.Local).AddTicks(5805),
                            ImageUrl = "",
                            Price = 8.5m,
                            Quantity = 100
                        },
                        new
                        {
                            ...
                            DrugName = "Cetirizine",
                            ExpiryDate = new DateTime(2025, 2, 12, 9, 47, 58, 562, DateTimeKind.Local).AddTicks(5808),
                            ImageUrl = "",
                            Price = 5.5m,
                            Quantity = 280
                        },
                        new
                        {
                            ...
                            DrugName = "Detrol",
                            ExpiryDate = new DateTime(2024, 2, 12, 9, 47, 58, 562, DateTimeKind.Local).AddTicks(5812),
                            ImageUrl = "",
                            Price = 12.5m,
                            Quantity = 50
                        },
                        new
                        {
                            ...
                            DrugName = "Diclofenac",
                            ExpiryDate = new DateTime(2025, 12, 12, 9, 47, 58, 562, DateTimeKind.Local).AddTicks(5814),
                            ImageUrl = "",
                            Price = 9.5m,
                            Quantity = 180
                        });
            ...
            modelBuilder.Entity("PharmacyManagementSystem.API.Models.Domain.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DrugId = new Guid("6119868f-6d63-4346-b637-7d4058a734bf"),
                            OrderDate = new DateTime(2023, 6, 12, 9, 47, 58, 562, DateTimeKind.Local).AddTicks(5853),
                            Quantity = 10,
                            Status = 0,
                        ...
                        new
                        {
                            ...
                            DrugId = new Guid("8a49f061-c88e-408c-947c-3fb24351d304"),
                            OrderDate = new DateTime(2023, 6, 12, 9, 47, 58, 562, DateTimeKind.Local).AddTicks(5861),
                            Quantity = 20,
                            Status = 2,
                            UserId = new Guid("9613f220-2650-4f63-bbb6-13ff6de4f0f6")
                        });
            ...
            modelBuilder.Entity("PharmacyManagementSystem.API.Models.Domain.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PaymentId = new Guid("0d67ce93-2c40-45ac-bd2e-cd98a832c63c"),
                            Amount = 102m,
                            Method = 0,
                            OrderId = new Guid("3d8cd2b2-1fa1-46da-9ced-0d1df92db769")
                        },
                        new
                        {
                            PaymentId = new Guid("3e430ae7-e43c-493a-af28-3cc42133c931"),
                            Amount = 190m,
                            Method = 2,
                            OrderId = new Guid("717e33d3-91aa-4417-b64b-bf104d059635")
                        });
            ...
            modelBuilder.Entity("PharmacyManagementSystem.API.Models.Domain.PickedUpOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PickedUpOrderId = new Guid("b9bfbf74-4aac-44c2-8db8-c3ff258ed088"),
                            OrderId = new Guid("717e33d3-91aa-4417-b64b-bf104d059635"),
                            PickedUpDate = new DateTime(2023, 6, 12, 9, 47, 58, 562, DateTimeKind.Local).AddTicks(5936)
                        });
                });
